...
export const getBudgetData = async (
  ...
  try {
    const response = await fetch("http://16.170.104.111:5000/budget/all", {
      headers: {
...
export const deleteBudgetData = async (_id: string): Promise<boolean> => {
  try {
    ...
    const response = await fetch(
      `http://16.170.104.111:5000/budget/delete/${_id}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
export const postBudgetData = async (
  ...
  try {
    const response = await fetch("http://16.170.104.111:5000/budget/add", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
...
export const updateBudgetData = async (
  ...
  try {
    ...
    const response = await fetch(
      `http://16.170.104.111:5000/budget/update/${budgetData._id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const useBudgetLimitFetch = () => {
  ...
  const fetchBudgetLimit = async (): Promise<void> => {
    try {
      const response = await fetch("http://16.170.104.111:5000/budget/limit", {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
